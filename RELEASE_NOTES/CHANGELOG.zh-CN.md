...
### 🌟 版本亮点
解决智能体挂起问题，提供更流畅的交互体验。

### ✨ 新功能
- 🔄 **窗口关闭自动响应**: 用户关闭反馈窗口时，智能体立即收到取消通知并继续工作
  - 不再需要等待 timeout 超时（600 秒）
  - 1-2 秒内即可解除智能体阻塞状态
  - 自动检测窗口关闭与正常提交的区别
  - 向后兼容，不影响正常反馈流程

### 🚀 改进功能
- ⚡ **响应速度提升**: 窗口关闭响应时间从 10 分钟降至 1-2 秒
- 🎯 **用户体验优化**: 误关窗口不再导致长时间等待

### 🐛 问题修复
- 修复关闭反馈窗口后智能体一直转圈（挂起）的问题
- 改进 WebSocket 断开检测逻辑
